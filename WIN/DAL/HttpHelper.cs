...
namespace DAL
{
    public class HttpHelper
    {
        ...
        /// <param name="postDataStr">发送的数据</param>
        /// <returns></returns>
        public static string ApiSendDataByPost(string Url, CookieContainer cookie, string postDataStr)
        {
            try
            {
                HttpWebRequest request = (HttpWebRequest)WebRequest.Create(Url);
                ...
                request.Referer = "https://api.weibo.com/chat/";

                request.Host = "api.weibo.com";
                //request.Connection = "keep-alive";
                request.UserAgent = "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.75 Safari/537.36";

                request.Headers.Set("Origin", "https://api.weibo.com");
