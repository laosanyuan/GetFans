...
namespace DAL
{
    public class JsonHelper
    {
        ...
        /// <param name="jsonStr"></param>
        /// <returns></returns>
        public static Model.OperatingWeiboBackJson GetWeiboBackJson(string jsonStr)
        {
            Model.OperatingWeiboBackJson backJson = new Model.OperatingWeiboBackJson();

            try
            {
                backJson = serializer.Deserialize<Model.OperatingWeiboBackJson>(jsonStr);
            }
            catch { }
