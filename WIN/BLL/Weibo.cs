...
namespace BLL
{
    public class Weibo
    {
        ...
        {
            return DAL.Weibo.GetNewestWeiboUrls(cookie, uid);
        }

        public static List<Model.CommentWeibo> GetFriendNewestWeiboMids(CookieContainer cookie)
        {
            return DAL.Weibo.GetFriendNewestWeibo(cookie);
        }
        #endregion

        #region [互动相关]
        public static bool CommentWeibo(CookieContainer cookie, string mid, string uid, string commentUid, string message, ref string result)
        {
            return DAL.Weibo.CommentWeibo(cookie, mid, uid, commentUid, message, ref result);
        }

        public static bool LikeWeibo(CookieContainer cookie, string mid)
        {
            return DAL.Weibo.LikeWeibo(cookie, mid);
        }
        #endregion
        ...
        public static List<string> GroupInviteFollowMe = new List<string>()
        {
            ...
            "在线秒回，欢迎互粉[心][心][心]   ——自动回粉功能由@极光互粉助手 提供",
